...
public class AdminApp extends JFrame {
    ...
    private String[] buttonsNames = {"Home", "Assign Rooms", "Maintain Staff Records", "Maintain User Accounts"};
    ...
    public AdminApp(String username) {
        ...
        ActionListener leftButtonClicked = e -> {
            ...
            if (from == buttons[0]) {
                ...
                right.repaint();
                right.revalidate();
                right.add(new InsertAndViewStaffFrame());
                right.repaint();
                right.revalidate();
                ...
                right.repaint();
                right.revalidate();
                right.add(new UserManagementFrame());
                right.repaint();
                right.revalidate();
            }
        };
    ...
    public JPanel Top(String username) {
        ...
        welcomeLabel.setBounds(110, 30, 450, 75);
        welcomeLabel.setFont(new Font(Font.SERIF, Font.BOLD, 35));
